...
esm_cortisol_data_WRO <- read_all_sheets("data_cleaning/esm-cortisol-WRO_20240715.xlsx")
esm_cortisol_data_SZCZ <- read_all_sheets("data_cleaning/esm-cortisol-SZCZ_20240715.xlsx")
esm_cortisol_data_WWA <- read_excel("data_cleaning/esm-cortisol-WWA_20240719.xlsx")
...
filename <- paste0("out_cleaning/clear_esm_cortisol_data_", current_time, ".sav")
# Zapis danych
...
#SCREENING_DATA
screening_data <- read_sav("data_cleaning/ALL_screening_20240426.sav")
...
current_time <- format(Sys.time(), "%Y%m%d_%H%M%S")
# Tworzenie nazwy pliku z aktualną datą i czasem
filename <- paste0("out_cleaning/clear_screening_data_", current_time, ".sav")
# Zapis danych
...
FKBP5_wywiad_data <- read_sav("data_cleaning/FKBP5+-+wywiad_July+12,+2024_16.03.sav")
...
current_time <- format(Sys.time(), "%Y%m%d_%H%M%S")
# Tworzenie nazwy pliku z aktualną datą i czasem
filename <- paste0("out_cleaning/clear_FKBP5_wywiad_data_", current_time, ".sav")
# Zapis danych
...
#FKBP5_BASELINE_DATA
#FKBP5_baseline_data_02_05 <- read_sav("C:/Users/huber/OneDrive/Dokumenty/GitHub/IPPAN_opus/data_cleaning/FKBP5+-+baseline_May+2,+2024_10.56.sav")
FKBP5_baseline_data <- read_sav("C:/Users/huber/OneDrive/Dokumenty/GitHub/IPPAN_opus/data_cleaning/FKBP5+-+baseline_July+12,+2024_16.04.sav")


#zamiana nazw kolumn
tmp_progress <- select(FKBP5_baseline_data, Progress, Finished, StartDate, EndDate)
FKBP5_baseline_col_names <- read_sav("C:/Users/huber/OneDrive/Dokumenty/GitHub/IPPAN_opus/data_cleaning/clear_FKBP5_baseline_data.sav")
...
current_time <- format(Sys.time(), "%Y%m%d_%H%M%S")
# Tworzenie nazwy pliku z aktualną datą i czasem
filename <- paste0("out_cleaning/clear_FKBP5_baseline_data_", current_time, ".sav")
# Zapis danych
